...
public interface PaginationStrategy<T> {
    ...
    /**
     *
     * Utility method to get list of indices sorted by their creation time with latestValidIndexCreateTime being used to filter out the indices created after it.
     */
