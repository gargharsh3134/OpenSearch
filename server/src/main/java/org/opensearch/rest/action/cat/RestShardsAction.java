...
public class RestShardsAction extends AbstractCatAction {
    ...
    protected Table getTableWithHeader(final RestRequest request) {
        return RestShardsActionCommonUtils.getTableWithHeader(request);
    }

    // package private for testing
    Table buildTable(RestRequest request, ClusterStateResponse state, IndicesStatsResponse stats) {
        return RestShardsActionCommonUtils.buildTable(request, state, stats);
    }

    public static class RestShardsActionCommonUtils {

        public static Table getTableWithHeader(final RestRequest request) {
            return getTableWithHeader(request, null);
        }

        public static Table getTableWithHeader(final RestRequest request, Table.PaginationMetadata paginationMetadata) {
        ...
        public static Table buildTable(RestRequest request, ClusterStateResponse state, IndicesStatsResponse stats) {
            return buildTable(request, state, stats, state.getState().routingTable().allShards(), null);
        }
